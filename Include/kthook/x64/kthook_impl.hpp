...
public:
    ...
    [[nodiscard]] std::uintptr_t get_return_address() const {
        return (using_ptr_to_return_address)
                   ? *last_return_address
                   : reinterpret_cast<std::uintptr_t>(last_return_address);
    }

    [[nodiscard]] std::uintptr_t* get_return_address_ptr() const {
        return (using_ptr_to_return_address)
                   ? last_return_address
                   : reinterpret_cast<std::uintptr_t*>(&last_return_address);
    }

    [[nodiscard]] const cpu_ctx& get_context() const { return context; }
...
public:
    ...
    [[nodiscard]] cpu_ctx& get_context() const { return context; }
    [[nodiscard]] std::uintptr_t& get_return_address() const { return last_return_address; }
